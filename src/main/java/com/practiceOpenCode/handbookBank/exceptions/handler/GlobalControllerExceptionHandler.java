...
public class GlobalControllerExceptionHandler {
    ...
    @ExceptionHandler(value = {DuplicateFileException.class, IncompatibleClassChangeError.class, NoSuchCodeException.class, NotFoundFileXmlException.class, UnmarshalXmlException.class, UnauthorizedException.class})
